Contributing to BSA Core
============================

The BSA Core project operates an open contributor model where anyone is
...
The following applies to code changes to the BSA Core project, and is not to be
confused with overall BSA Network Protocol consensus changes.

Whether a pull request is merged into BSA Core rests with the project merge
...
Patches that change BSA consensus rules are considerably more involved than
...
Where a patch set proposes to change the BSA consensus, it must have been
...
The project leader is the release manager for each BSA Core release.
