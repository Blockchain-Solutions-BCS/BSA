...
RESOURCES += src/qt/bsa.qrc src/qt/bsa_locale.qrc

TRANSLATIONS += src/qt/locale/bsa_bg.ts \
                src/qt/locale/bsa_de.ts \
                src/qt/locale/bsa_en.ts \
                src/qt/locale/bsa_es.ts \
                src/qt/locale/bsa_fi.ts \
                src/qt/locale/bsa_fr.ts \
                src/qt/locale/bsa_it.ts \
                src/qt/locale/bsa_ja.ts \
                src/qt/locale/bsa_pl.ts \
                src/qt/locale/bsa_pt.ts \
                src/qt/locale/bsa_ru.ts \
                src/qt/locale/bsa_sk.ts \
                src/qt/locale/bsa_sv.ts \
                src/qt/locale/bsa_vi.ts \
                src/qt/locale/bsa_zh_CN.ts \
                src/qt/locale/bsa_zh_TW.ts
