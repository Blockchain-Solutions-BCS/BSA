...
This means one can have an always-on bsad instance running, and another local bsad/bsa-qt instance which connects to this node and receives blocks from it.
