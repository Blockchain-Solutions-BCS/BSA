...
In order to support loading of multiple wallets in bsa-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is bsa.cpp.
...
Changes to bsa.cpp
----------------------
bsa.cpp is the entry point into bsa-qt, and as such, will require some minor modifications to provide hooks for
