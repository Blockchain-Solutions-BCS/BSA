...
#   c) node1 mines 32 blocks, so now node 0 has 60001bsa, node 1 has 4250bsa, node2 has none.
#   d) node0 sends 601 bsa to node2, in two transactions (301 bsa, then 300 bsa).
