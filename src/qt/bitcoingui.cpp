                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    GUIUtil::restoreWindowGeometry("nWindow", QSize(1050, 550), this);

    QString windowTitle = tr("BSA Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a BSA address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and bsa: URIs)"));
    ...
    privacyAction->setStatusTip(tr("Privacy Actions for zBSA"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About BSA Core"), this);
    aboutAction->setStatusTip(tr("Show information about BSA Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for BSA"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your BSA addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified BSA addresses"));
    ...
    openAction->setStatusTip(tr("Open a BSA: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the BSA Core help message to get a list with possible BSA command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("BSA Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to BSA network", "", count));
}
...
{
    QString strTitle = tr("BSA Core"); // default title
