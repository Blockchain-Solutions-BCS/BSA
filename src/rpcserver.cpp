...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* BSA features */
        {"bsa", "masternode", &masternode, true, true, false},
        {"bsa", "listmasternodes", &listmasternodes, true, true, false},
        {"bsa", "getmasternodecount", &getmasternodecount, true, true, false},
        {"bsa", "masternodeconnect", &masternodeconnect, true, true, false},
        {"bsa", "masternodecurrent", &masternodecurrent, true, true, false},
        {"bsa", "masternodedebug", &masternodedebug, true, true, false},
        {"bsa", "startmasternode", &startmasternode, true, true, false},
        {"bsa", "createmasternodekey", &createmasternodekey, true, true, false},
        {"bsa", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"bsa", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"bsa", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"bsa", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"bsa", "getmasternodescores", &getmasternodescores, true, true, false},
        {"bsa", "mnbudget", &mnbudget, true, true, false},
        {"bsa", "preparebudget", &preparebudget, true, true, false},
        {"bsa", "submitbudget", &submitbudget, true, true, false},
        {"bsa", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"bsa", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"bsa", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"bsa", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"bsa", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"bsa", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"bsa", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"bsa", "checkbudgets", &checkbudgets, true, true, false},
        {"bsa", "mnsync", &mnsync, true, true, false},
        {"bsa", "spork", &spork, true, true, false},
        {"bsa", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"bsa", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use bsad, or the -server option to bsa-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> bsa-cli " + methodname + " " + args + "\n";
}
